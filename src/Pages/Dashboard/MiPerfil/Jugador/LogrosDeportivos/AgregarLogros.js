...
const AgregarLogros = ({ Paises, Tipo_instituciones, Tipo_institucion, setTipo_institucion, Categorias, Categoria, setCategoria, Pais, setPais, NombreTorneo, setNombreTorneo, NombreLogro, setNombreLogro, Fecha, setFecha, setViewAgregar }) => {
    return (
        <div>
            <div className='d-flex flex-column'>
                ...
                <div className='row mt-2'>
                    <div className="mt-3 col-12 centrar-input">
                        ...
                        <input type="text" className="form-control" id="NombreInstitucion" placeholder="Nombre del torneo" required="" value={NombreTorneo} onChange={(e) => setNombreTorneo(e.target.value)} />
                    </div>
