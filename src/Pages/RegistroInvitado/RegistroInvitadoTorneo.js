...
const RegistroInvitadoTorneo = () => {
    ...
    useEffect(() => {
        ...
        fetchData(Request, "torneo_invitacion_validar_token", [
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const data = await fetchData(Request, "torneo_invitacion_aceptar", [
                { nombre: "token", envio: token },
                        ...
                        <>
                            ...
                            <div className="p-3 rounded mb-4" style={{ background: 'var(--bg-primary)', border: '1px solid var(--border-color)' }}>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <span className="badge bg-info">Veedor / Planillero</span>
                                    </div>
                                </div>
                            </div>
...
export default RegistroInvitadoTorneo;
